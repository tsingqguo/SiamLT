% -------------------------------------------------------------------------------------------------
function net = make_HOGConv(opts)
% make dliatedconv
% borrowed from SiamFC
% -------------------------------------------------------------------------------------------------------
    net_opts.siamese = true;
    net_opts.batchNormalization = true;
    net_opts.strides = [1,1,1];
    ...
    branch = vid_create_net_HOGConv(...
        'exemplarSize',       opts.exemplarSize * [1 1], ...
        'instanceSize',       opts.instanceSize * [1 1], ...
        'num_Channel',opts.features{1}.fparams.num_channel,...
    ...
    net.addLayer('xcorrf', XCorrf(), ...
                 {'a_feat', 'b_feat'}, ...
                 {'xcorrf_out'}, ...
                 {});

    add_adjust_layer(net, 'adjust', 'xcorrf_out', 'score', ...
